...
- Die TypeScript-Version nutzt Qdrants HTTP API über `QDRANT_BASE_URL`; `QDRANT_GRPC_PORT` bleibt in `.env`, damit `init` die Docker-Compose-Portbelegung weiter abfragen und setzen kann.
