...
- `init` — fragt `.env` interaktiv ab. Qdrant wird als vollständige URL abgefragt; bei nicht erreichbaren lokalen Diensten kann es Docker Compose starten. Für entfernte Dienste wird nur auf den ausstehenden Start hingewiesen. Außerdem prüft es die gewählten Ollama-Modelle und kann fehlende Modelle installieren.
